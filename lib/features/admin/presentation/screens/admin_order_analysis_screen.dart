...
class _AdminOrderAnalysisScreenState extends State<AdminOrderAnalysisScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Order Analysis', style: GoogleFonts.outfit(fontWeight: FontWeight.w800, fontSize: 18)),
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('No work orders found.', style: GoogleFonts.outfit(color: Colors.grey[500], fontWeight: FontWeight.w600)),
                      ],
                    ),
                  );
                }
...
class _OrderAnalysisCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalAmount = (orderData['grandTotal'] ?? 0.0).toDouble();
    
    final estimatedCost = totalAmount * 0.6;
      ...
      child: UCard(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'WO: $woNo',
                        style: GoogleFonts.outfit(fontWeight: FontWeight.w800, fontSize: 16, color: _brandPurple, letterSpacing: -0.5),
                      ),
            ...
            Row(
              children: [
                _StatItem(label: 'Estimated Profit', value: '৳${NumberFormat('#,###').format(estimatedProfit)}', color: Colors.green),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('SPEED UP THIS ORDER', style: GoogleFonts.outfit(fontWeight: FontWeight.w800, fontSize: 13, letterSpacing: 0.5)),
  ...
  void _showSpeedUpDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Priority Speed Up', style: GoogleFonts.outfit(fontWeight: FontWeight.w800)),
        content: Text('Notify the production floor to prioritize Work Order $docId for $buyer?', style: GoogleFonts.plusJakartaSans(fontSize: 14)),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            ...
            child: Text('Request Priority', style: GoogleFonts.outfit(fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          Text(
            label,
            style: GoogleFonts.plusJakartaSans(fontSize: 10, color: Colors.grey[500], fontWeight: FontWeight.w800, letterSpacing: 0.2),
          ),
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        status.toUpperCase(),
        style: GoogleFonts.outfit(fontSize: 10, fontWeight: FontWeight.w900, color: _brandPurple, letterSpacing: 0.5),
      ),
    );
  }
}
