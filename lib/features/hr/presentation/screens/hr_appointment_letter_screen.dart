...
// ─────────────────────────────────────────────────────────────────────────────
class HrAppointmentLetterScreen extends StatefulWidget {
  const HrAppointmentLetterScreen({super.key});
  @override
  State<HrAppointmentLetterScreen> createState() => _HrAppointmentLetterScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Appointment Generation', style: GoogleFonts.outfit(fontWeight: FontWeight.w800, fontSize: 18)),
      ),
      body: ListView(
        ...
        children: [
          ...
          UCard(
            ...
            child: Column(
              children: [
                _ModernField(label: 'Letter Reference', controller: _letterNoCtrl, hint: 'HR/APP/2024/001'),
                const SizedBox(height: 16),
                _ModernField(label: 'Gross Salary (Monthly)', controller: _grossCtrl, hint: '85,000', prefix: '৳ '),
              ],
            ),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text('GENERATE OFFICIAL PDF', style: GoogleFonts.outfit(fontWeight: FontWeight.w800, letterSpacing: 1.1)),
...
class _CandidateSelector extends StatelessWidget {
  ...
  const _CandidateSelector({required this.onSelected});
  @override
  Widget build(BuildContext context) => UCard(
    padding: const EdgeInsets.all(16),
    child: Row(
      children: [
        const Icon(Icons.person_search_rounded, color: _brandGreen),
        const SizedBox(width: 14),
        Expanded(child: Text('Select from workforce registry...', style: GoogleFonts.plusJakartaSans(color: Colors.grey[400], fontWeight: FontWeight.w600))),
