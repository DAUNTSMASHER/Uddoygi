// lib/features/factory/presentation/factory/pending_work_orders_screen.dart
...
class PendingWorkOrdersScreen extends StatefulWidget {
  const PendingWorkOrdersScreen({Key? key}) : super(key: key);

  @override
  State<PendingWorkOrdersScreen> createState() => _PendingWorkOrdersScreenState();
}

class _PendingWorkOrdersScreenState extends State<PendingWorkOrdersScreen> {
  String _cid = '';
  ...
  void _onNavTabSelected(FactoryNavTab tab) {
    if (tab == FactoryNavTab.pending) return;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FactoryBottomNav(
        currentTab: FactoryNavTab.pending,
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Filter pending by ID or client...',
  ...
  Widget _buildOrdersList() {
    ...
    if (docs.isEmpty) {
      return const Center(child: Padding(padding: EdgeInsets.all(20), child: Text('No pending orders found.')));
    }
